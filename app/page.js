...
const faqs = [
  {
    ...
    answer:
      "Agile Pro is a powerful project management tool designed to help teams organize, track, and manage their work efficiently. It combines intuitive design with robust features to streamline your workflow and boost productivity.",
  },
  {
    question: "How does Agile Pro compare to other project management tools?",
    answer:
      "Agile Pro offers a unique combination of intuitive design, powerful features, and flexibility. Unlike other tools, we focus on providing a seamless experience for both agile and traditional project management methodologies, making it versatile for various team structures and project types.",
  },
  {
    question: "Is Agile Pro suitable for small teams?",
    answer:
      "Absolutely! Agile Pro is designed to be scalable and flexible. It works great for small teams and can easily grow with your organization as it expands. Our user-friendly interface ensures that teams of any size can quickly adapt and start benefiting from Agile Pro's features.",
  },
  {
    question: "What key features does Agile Pro offer?",
    answer:
  ...
  {
    question: "Can Agile Pro handle multiple projects simultaneously?",
    answer:
      "Yes, Agile Pro is built to manage multiple projects concurrently. You can easily switch between projects, and get a bird's-eye view of all your ongoing work. This makes Agile Pro ideal for organizations juggling multiple projects or clients.",
  },
  {
    question: "Is there a learning curve for new users?",
    answer:
      "While Agile Pro is packed with features, we've designed it with user-friendliness in mind. New users can quickly get up to speed thanks to our intuitive interface, helpful onboarding process, and comprehensive documentation.",
  },
];
      ...
      <section className="py-20 text-center px-5">
        <div className="container mx-auto">
          ...
          <p className="text-xl mb-12">
            Join thousands of teams already using Agile Pro to streamline their
